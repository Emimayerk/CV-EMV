    ...
    <React.Fragment>
      <div className='block-contact'>
        ...
        <div className='box-qr'>
          <a class='button' href='mailto: emilianomayerviegas@gmail.com' target='blank_'>
          ...
          <a class='button' href='tel:+543465405225' target='blank_'>
            <div className='description-qr'>
              <h5> TELÉFONO </h5>
              <QRCode className='qr-img' value='tel:+543465405225' size='85' bgColor='#272727' fgColor='#fff' />
            </div>
          </a>
          <a class='button' href='https://api.whatsapp.com/send?phone=+543465405225' target='blank_'>
            <div className='description-qr'>
              <h5>WHATSAPP</h5>
              <QRCode className='qr-img' value='https://api.whatsapp.com/send?phone=+543465405225' size='85' bgColor='#272727' fgColor='#fff' />
            </div>
          </a>
          <a class='button' href='https://www.linkedin.com/in/emiliano-mayer-viegas-03a0a41b2/' target='blank_'>
            <div className='description-qr'>
              <h5>LINKEDIN</h5>
